...
export default function FloatingChat() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-4">
      <div
        className={`flex flex-col gap-4 transition-all duration-300 ease-in-out transform ${
      ...
      >
        <a
          ...
          className="w-14 h-14 bg-[#25D366] rounded-full shadow-lg flex items-center justify-center text-white hover:scale-110 transition-transform duration-200 group relative"
        ...
        <a
          href={emailUrl}
          className="w-14 h-14 bg-[#FF4B55] rounded-full shadow-lg flex items-center justify-center text-white hover:scale-110 transition-transform duration-200 group relative"
      ...
      <button
        ...
        className={`w-16 h-16 rounded-full shadow-2xl flex items-center justify-center text-white transition-all duration-300 ${
          isOpen ? 'bg-blue-600 rotate-90' : 'bg-[#4e6bf3] hover:bg-blue-600'
        }`}
